              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form method="post" action="{{route('changePassword')}}">
                    ...
                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Change password your account</h5>
                    <div class="form-outline mb-4 @error('password') is-invalid @enderror">
                      <input type="password" name="oldpassword" id="form2Example27" class="form-control form-control-lg" />
